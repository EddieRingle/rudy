...
import io.ringle.statesman.RudyContextWrapper
import io.ringle.statesman.statesman
import io.ringle.statesman.store
import kotlin.properties.Delegates

public open class RoutableActivity : Activity(), Stateful {
    ...
    override fun attachBaseContext(newBase: Context) {
        super<Activity>.attachBaseContext(RudyContextWrapper(newBase))
    }
